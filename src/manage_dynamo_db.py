...
def get_dynamodb_client():
    dynamodb = boto3.client("dynamodb", region_name="sa-east-1c", endpoint_url="http://localhost:8000")
    """ :type : pyboto3.dynamodb """
    return dynamodb


def get_dynamodb_resource():
    dynamodb = boto3.resource("dynamodb", region_name="sa-east-1c", endpoint_url="http://localhost:8000")
    """ :type : pyboto3.dynamodb """
    return dynamodb
